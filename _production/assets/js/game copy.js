...
(function () {
	...
	Game.preloadItems.push({type:"image",name:"background",path:"assets/images/landscape/background.png"});
	Game.preloadItems.push({type:"image",name:"level2",path:"assets/images/landscape/level2.png"});
	Game.preloadItems.push({type:"image",name:"level3",path:"assets/images/landscape/level3-bench.png"});
	Game.preloadItems.push({type:"image",name:"level4",path:"assets/images/landscape/level4-city.png"});
	Game.preloadItems.push({type:"image",name:"level5",path:"assets/images/landscape/level5-trees.png"});
	Game.preloadItems.push({type:"image",name:"frame",path:"assets/images/landscape/frame.png"});
...
(function () {
	...
	Game.EnemySaucer = function(level) {
		...
		*/
		...
		//Create the enemy ship sprite
		Phaser.Sprite.call(this, this.level.game, this.level.mothership.x,this.level.mothership.y, 'enemySaucer');
	...
	*/
	...
	Game.Rocket.prototype.fireWeapon = function()
    {
		...
		if (bullet)
		{
			...
			bullet.reset(this.x+(100 * direction), this.y);
